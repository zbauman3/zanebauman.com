...
export const Footer = () => {
  return (
    <footer className="flex justify-center grow-0 shrink-0 w-screen bg-inherit border-t-[1px] border-t-solid border-t-neutral-200 dark:border-t-neutral-800 mt-6">
